...
import imageSprLessonBuilderDarkLarge from '~/assets/CasaMiaHome.png';
import imageSprLessonBuilderDarkPlaceholder from '~/assets/CasaMiaHome.png';
...
const title = 'Find Your Best Coliving Home in Singapore';
const description =
  'Find a fully furnished room to rent, surrounded by like-minded folk, in your favourite Singapore neighbourhoods. Ideal for students and young professionals.';
const roles = [
      ...
      <ProjectContainer>
        ...
        <ProjectSection>
          <ProjectTextRow>
            ...
            <ProjectSectionText>
            Casa Mia Coliving addresses the challenges faced by young professionals and students in finding affordable, fully-furnished, and community-driven housing in urban areas. Traditional rentals often involve high upfront costs, long lease commitments, and isolation. Casa Mia solves this by offering move-in-ready shared apartments with flexible lease terms, utilities included, and a built-in social community. It simplifies the rental process, reduces living expenses, and promotes meaningful connections among housemates. With curated coliving spaces, Casa Mia creates a hassle-free, comfortable, and engaging living experience in prime city locations, ideal for those seeking convenience, affordability, and a sense of belonging.
            </ProjectSectionText>
          </ProjectTextRow>
        </ProjectSection>
