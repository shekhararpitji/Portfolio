...
import sliceAppLarge from '~/assets/SMARTeISHOME.png';
import sliceAppPlaceholder from '~/assets/slice-app-placeholder.jpg';
import sliceApp from '~/assets/slice-app.jpg';
import sliceBackgroundBarLarge from '~/assets/slice-background-bar-large.jpg';
import sliceBackgroundBarPlaceholder from '~/assets/slice-background-bar-placeholder.jpg';
import sliceBackgroundBar from '~/assets/slice-background-bar.jpg';
import sliceBackgroundLarge from '~/assets/SMAETeIS.png';
import sliceBackgroundPlaceholder from '~/assets/slice-background-placeholder.jpg';
import sliceBackground from '~/assets/slice-background.jpg';
import sliceIrlPlaceholder from '~/assets/slice-irl-placeholder.jpg';
import sliceIrl from '~/assets/slice-irl.jpg';
import sliceSidebarAnnotationsLarge from '~/assets/invoice-bill-paid.jpg';
...
const title = 'Smart Electronic Invoicing System';
const description =
  'Skill Quotient Technologies heralds a new era of business empowerment with the introduction of SMARTeIS, an all-encompassing e-Invoicing solution meticulously crafted for the Malaysian market.';
const roles = ['Frontend', 'Backend', "Deployment"];
    ...
    <Fragment>
      <ProjectContainer className={styles.slice}>
        ...
        <ProjectHeader
          ...
          url="https://skillquotientgroup.com/e-invoicing-smarteis/"
          roles={roles}
        />
